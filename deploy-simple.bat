...
echo echo.
echo.
echo uv run python main_simple.py suite
echo.
echo echo.
...
echo uv run python main_simple.py backend
echo pause
) > start-backend.bat
...
echo uv run python main_simple.py webui
echo pause
) > start-webui.bat
...
echo   - main_simple.py (simple launcher)
